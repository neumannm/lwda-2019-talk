...
\begin{frame}{\currentname}\linespread{1.5}
    \begin{figure}
      \begin{center}
        \includegraphics[width=\textwidth,height=0.8\textheight,keepaspectratio]{img/dblp_author_entry.eps}
      \end{center}
    \end{figure}
\end{frame}
\note[itemize]{
...
\begin{frame}{\currentname}\linespread{1.5}
    \begin{figure}
      \begin{center}
        \includegraphics[width=\textwidth,height=0.8\textheight,keepaspectratio]{img/dblp_journal.eps}
      \end{center}
    \end{figure}
\end{frame}
\note[itemize]{
...
\begin{frame}{\currentname}\linespread{1.5}
    \begin{figure}
      \begin{center}
        \includegraphics[width=\textwidth,height=0.8\textheight,keepaspectratio]{img/dblp_conference.eps}
      \end{center}
    \end{figure}
\end{frame}
\note[itemize]{
...
\begin{frame}{\currentname}\linespread{1.5}
    \begin{figure}
      \begin{center}
        \includegraphics[width=\textwidth,height=0.8\textheight,keepaspectratio]{img/dblp_proceeding.eps}
      \end{center}
    \end{figure}
\end{frame}
\note[itemize]{
...
\begin{figure}
  \begin{center}
    \includegraphics[width=\textwidth,height=0.6\textheight,keepaspectratio]{img/documents.eps}
  \end{center}
\end{figure}
\end{frame}
\note[itemize]{
